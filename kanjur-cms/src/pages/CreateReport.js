...
function CreateReport() {
  ...
  return (
    <div style={{ display: "flex" }}>
      <Navbar />
      <div className="row card container" style={{ width: "85vw", marginTop: "2vh", height: "95vh" }}>
        ...
        <div className="card col-12 table-wrapper-scroll-y table-responsive my-custom-scrollbar" style={{ height: "60%" }}>
